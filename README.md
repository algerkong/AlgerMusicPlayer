...
**LYMusic**（`LYMusicPlayer`）是基于 [AlgerMusicPlayer](https://github.com/algerkong/AlgerMusicPlayer) 的个人魔改版。

- 作者：落叶🍂 ([@LuoYe17](https://github.com/LuoYe17))
- 仓库：https://github.com/LuoYe17/AlgerMusicPlayer

> [!IMPORTANT]
> 本项目仍在开发中，功能、界面和数据结构可能随时调整。当前版本不代表最终完成状态，使用前请留意版本说明并自行备份重要数据。

主要能力继承自上游：第三方音乐播放、歌词展示、下载等。
...
- 发布与更新源指向本仓库
- 聚焦核心播放体验，精简 Android、本地音乐、桌面歌词、远程控制、定时关闭、心动模式、多语言及快捷键自定义等功能
