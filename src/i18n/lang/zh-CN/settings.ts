export default {
  ...
  playback: {
    ...
    pureMode: '纯净模式',
    pureModeDesc: '播放页仅保留封面与歌词，隐藏角落控制按钮；可随时在此关闭',
    audioDevice: '音频输出设备',
  ...
  lyricSettings: {
    ...
    pureMode: '纯净模式',
    pureModeTip:
      '开启后隐藏播放页左上角与右上角的控制按钮，鼠标悬停原位置可重新显示；也可在「设置 → 播放设置」中关闭',
    pureModeOnboarding:
      '控制按钮就藏在这里，将鼠标移入即可唤出；也可在「设置 → 播放设置」中随时关闭',
    pureModeOnboardingStep2: '收起按钮藏在这里，鼠标移入即可唤出，点击可返回',
    hideCover: '隐藏封面',
    centerDisplay: '居中显示',
