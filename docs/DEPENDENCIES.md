...
| 2026-07-16 | `chore/upgrade-deps`（进行中）               | 其余依赖批量升级 + ESLint→Oxlint                        |

## 刻意未升

| 包          | 锁定   | latest | 原因                        |
| ----------- | ------ | ------ | --------------------------- |
| typescript  | 5.9.3  | 7.x    | vue-tsc 不兼容 TS 7         |
| vite        | 7.3.6  | 8.x    | electron-vite@5 上限 Vite 7 |
| tailwindcss | 3.4.19 | 4.x    | v4 需单独迁移               |
